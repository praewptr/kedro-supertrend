...
# kedro_supertrend documentation build
...
from kedro_supertrend import __version__ as release

# -- Project information -----------------------------------------------------

project = "kedro_supertrend"
author = "Kedro"
...
htmlhelp_basename = "kedro_supertrenddoc"
...
latex_documents = [
    (
        master_doc,
        "kedro_supertrend.tex",
        "kedro_supertrend Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_supertrend",
        "Project kedro_supertrend codebase.",
        "Data-Science",
    )
]
